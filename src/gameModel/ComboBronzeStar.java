...
/**
 * This class displays the bronze star, first combo, when it's necessary
 * @author Romain
 *
 */

public class ComboBronzeStar implements Observer {
	...
	private int timeEnd = 1000;					// Duration of the note
	...
	private MediaPlayerBackground mediaPlayerBackground;
	 ...
	 public ComboBronzeStar(MediaPlayerBackground mediaPlayerBackground, Game game, String song, Bitmap bitmap, int d, int e, boolean isPrinted, int fps, int frameCount) {
	...
	public void update(Observable observable, Object data) {
		...
		if (((Combo)observable).getCurrentCombo() == 10) {
		isPrinted=true;
