...
/**
 * This class displays the silver star, first combo, when it's necessary
 * @author Romain
 *
 */

public class ComboSilverStar implements Observer {
	...
	private int timeEnd = 5000;					// Duration of the note
	...
	private MediaPlayerBackground mediaPlayerBackground;
	 ...
	 public ComboSilverStar(MediaPlayerBackground mediaPlayerBackground, Game game, String song, Bitmap bitmap, int d, int e, boolean isPrinted, int fps, int frameCount) {
	...
	public void update(Observable observable, Object data) {
		...
		if (((Combo)observable).getCurrentCombo() == 20) {
		isPrinted=true;
